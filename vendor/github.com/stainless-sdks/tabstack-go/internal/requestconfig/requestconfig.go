...
import (
	...
	"github.com/stainless-sdks/tabstack-go/internal"
	"github.com/stainless-sdks/tabstack-go/internal/apierror"
	"github.com/stainless-sdks/tabstack-go/internal/apiform"
	"github.com/stainless-sdks/tabstack-go/internal/apiquery"
)

func getDefaultHeaders() map[string]string {
	return map[string]string{
		"User-Agent": fmt.Sprintf("Tabstack/Go %s", internal.PackageVersion),
	}
}
